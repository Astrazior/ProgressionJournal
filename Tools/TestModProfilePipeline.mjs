...
assert(exactDropCatalogSource.includes("ThoriumMod/YewTreeShaking")
  && exactDropCatalogSource.includes("ThoriumMod/SnowyTreeShaking")
  && exactDropCatalogSource.includes("ThoriumMod/DeadTreeShaking")
  && exactDropCatalogSource.includes("ThoriumMod/SpookyTreeShaking")
  && exactDropCatalogSource.includes("ThoriumMod/SakuraTreeShaking")
  && exactDropCatalogSource.includes("CalamityMod/AstralTreeShaking")
  && exactDropCatalogSource.includes("CalamityMod/AstralSnowTreeShaking")
  && exactDropCatalogSource.includes("Mods.ProgressionJournal.UI.CalamitasExhumingCondition")
  && exactDropCatalogSource.includes("ThoriumMod/MeleeThorHammer")
  && exactDropCatalogSource.includes("ThoriumMod/RangedThorHammer")
  && exactDropCatalogSource.includes("ThoriumMod/MagicThorHammer")
  && exactShopCatalogSource.includes("ThoriumMod/ConfusedZombie")
  && exactShopCatalogSource.includes("Terraria/TravellingMerchant")
  && containerLootCatalogSource.includes("ThoriumMod/ScarletChest")
  && containerLootCatalogSource.includes("ThoriumMod/RingofUnity")
  && englishLocalizationSource.includes("one random repellent out of five")
  && russianLocalizationSource.includes("один из пяти случайных репеллентов"),
  "Thorium and Calamity custom tree, conversion, service, and chest sources must remain exported");
